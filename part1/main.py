...
def run_softmax_on_MNIST(temp_parameter):
    ...
    tst_error_mod3 = compute_test_error_mod3(test_x, test_y_mod3, theta, temp_parameter)

    # Save the model parameters theta obtained from calling softmax_regression to disk.
    write_pickle_data(theta, "./theta.pkl.gz")


    return test_error,tst_error_mod3
...
#Finding the error rate for temp_parameter = [.5, 1.0, 2.0]
...
print("Test error on implementing PCA:",test_error)
...
## Cubic Kernel ##
#  Finding the 10-dimensional PCA representation of the training and test set
n_components = 10
...
print("Test error on implementing PCA:",test_error_cube)
